...
def main():
    ...
    #apiros.talk(["/ip/hotspot/user/add", "=name=" + '380979702007', "=password=" + '1q2w3e',])

    apiros.talk(["/system/reboot"])

    #hotspot_users = apiros.talk(["/ip/hotspot/user/print"])


    #print('################################')
    #for i in hotspot_users:
    #    print(i[1]['=name'])
